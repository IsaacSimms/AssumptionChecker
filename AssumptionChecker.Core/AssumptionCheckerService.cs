...
namespace AssumptionChecker.Core
{
    ...
    public interface IAssumptionCheckerService
    {
        ...
        // == AnalyzeAsync == //
        Task<AnalyzeResponse> AnalyzeAsync(string prompt, int maxAssumptions, string model = "gpt-4o-mini", List<FileContext>? fileContexts = null, CancellationToken cancellationToken = default);
    }
}
