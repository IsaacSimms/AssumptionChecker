...
namespace AssumptionChecker.Core
{
    ...
    public interface IAssumptionCheckerService
    {
        ...
        // == AnalyzeAsync == //
        Task<AnalyzeResponse> AnalyzeAsync(string prompt, int maxAssumptions, string model = "claude-haiku-4-5", List<FileContext>? fileContexts = null, CancellationToken cancellationToken = default);
    }
}
