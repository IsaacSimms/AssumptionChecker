...
namespace AssumptionChecker.Contracts
{
    ...
    public class Assumption
    {
        ...
        public string? ClarifyingQuestion           { get; set; } // A clarifying question that can be asked to validate or refute the assumption (make sure this is not forced on the user if not required for the assumption)
        ...
        public double Confidence                    { get; set; } // A score representing the confidence in the assumption being true, typically ranging from 0 to 1
    }
}
